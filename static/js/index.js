document.querySelector('div.send').onclick = function () {
    ...
    xhr.open('POST', '/new_student_request', true);
...
document.querySelector('#intro .license').onclick = function () {
    document.querySelector('div.bg-modal.license').classList.toggle('show');
    document.querySelector('.license button.close').onclick = function () {
        document.querySelector('div.bg-modal.license').classList.toggle('show');
    }
}
